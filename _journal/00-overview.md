...
на движке **Ren'Py**. Автор: **foulnike**. Лицензия GPL-3.0. v1.3.0 готовится к релизу (dev),
версия во всех файлах уже забампана; прод пока v1.2.0 до публикации релиза.
